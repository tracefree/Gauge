...
Gauge::InitializeImGui(const RendererVulkan& p_renderer) {
  ...
  //  }
    ...
    ImGui_ImplVulkan_InitInfo imgui_info{
        .Instance = p_renderer.ctx.instance.instance,
        .PhysicalDevice = p_renderer.ctx.physical_device.physical_device,
        .Device = p_renderer.ctx.device.device,
        .Queue = p_renderer.ctx.graphics_queue,
        ...
        .PipelineRenderingCreateInfo = {
            ...
            .pColorAttachmentFormats = &p_renderer.swapchain.image_format,
        },
    };
